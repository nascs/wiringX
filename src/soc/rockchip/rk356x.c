...
static struct layout_t
{
    ...
    {"GPIO4_D0", 4, {CRU_GATE_CON31, 8}, {GRF_GPIO4D_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  8}, {GPIO_SWPORT_DR_H,  8}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D1", 4, {CRU_GATE_CON31, 8}, {GRF_GPIO4D_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  9}, {GPIO_SWPORT_DR_H,  9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D2", 4, {CRU_GATE_CON31, 8}, {GRF_GPIO4D_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H, 10}, {GPIO_SWPORT_DR_H, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D3", 4, {CRU_GATE_CON31, 8}, {GRF_GPIO4D_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H, 11}, {GPIO_SWPORT_DR_H, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
...
static int rk356xPinMode(int i, enum pinmode_t mode)
{
    ...
    if (mode == PINMODE_INPUT) {
        REGISTER_CLEAR_BITS(dir_reg, pin->data.bit, 1);
